...
public class PrivacyPolicyActivity extends LifecycleAppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) findViewById(R.id.txtPrivacy)).setText(Html.fromHtml(getString(R.string.privacy_policy_text)));
    }
}
